    ...
    <div className="min-h-screen bg-[#0E1420] text-[#E8EAF0] flex flex-col justify-center items-center px-4">
      <div className="w-full max-w-md bg-[#161D2C] border border-[#2A3346] rounded p-6 shadow-2xl space-y-6">
        ...
        <div className="border-t border-[#2A3346] pt-4">
          <h2 className="text-sm font-semibold text-[#E8EAF0] mb-1">Create your account</h2>
          <p className="text-xs text-[#8B92A8]">Sign up to start modeling and isolating your startup scenarios</p>
        </div>
        ...
        {successMsg && (
          <div className="p-2.5 bg-[#4A7C64]/10 border border-[#4A7C64]/40 rounded text-xs text-[#4A7C64]">
            {successMsg}
          </div>
        )}
        ...
        <div className="text-center pt-2 text-xs text-[#8B92A8]">
          ...
          <Link href="/login" className="text-[#C9A15D] hover:underline font-medium">
            Sign in
          </Link>
        </div>
      </div>
